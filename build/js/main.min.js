...
/* harmony import */ var _modules_text_expand_text_expand__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/text-expand/text-expand */ "./js/modules/text-expand/text-expand.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_text_expand_text_expand__WEBPACK_IMPORTED_MODULE_3__["textExpand"])();
  });
});
...
/*!***********************************************!*\
  !*** ./js/modules/text-expand/text-expand.js ***!
  \***********************************************/
/*! exports provided: textExpand */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "textExpand", function() { return textExpand; });
...
var expandButton = document.querySelector('[data-expand-button="data-expand-button"]');
var textToggle = function textToggle() {
  if (expandButton.classList.contains('is-closed')) {
    ...
    if (window.innerWidth >= 768) {
      ...
      hiddenText.style.height = "".concat(hiddenText.previousElementSibling.clientHeight * 1.65, "px");
    }
    if (window.innerWidth < 768) {
      mobileHiddenText.style.display = 'block';
      mobileHiddenText.style.height = "".concat(hiddenText.previousElementSibling.clientHeight * 0.7, "px");
    }
  } else {
...
var textExpand = function textExpand() {
