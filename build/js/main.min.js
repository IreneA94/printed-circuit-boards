...
/* harmony import */ var _modules_aboutus_aboutus__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/aboutus/aboutus */ "./js/modules/aboutus/aboutus.js");
/* harmony import */ var _modules_accordeon_init_accordion__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/accordeon/init-accordion */ "./js/modules/accordeon/init-accordion.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    Object(_modules_accordeon_init_accordion__WEBPACK_IMPORTED_MODULE_4__["initAccordions"])();
    Object(_modules_aboutus_aboutus__WEBPACK_IMPORTED_MODULE_3__["aboutUsButtonClick"])();
  });
});
...
var textToggle = function textToggle() {
  if (aboutUsButton.classList.contains('is-closed')) {
    ...
    if (window.innerWidth >= 768) {
      hiddenText.style.height = "".concat(hiddenText.previousElementSibling.clientHeight, "px");
    } else {
...
var Accordions = /*#__PURE__*/function () {
  ...
  _createClass(Accordions, [{
    ...
    value: function openAccordion(element) {
      ...
      var accordeonButton = element.querySelector('[data-accordion="button"]');
      var plusIcon = accordeonButton.querySelector('.footer__accordeon-icon--plus');
      var minusIcon = accordeonButton.querySelector('.footer__accordeon-icon--minus');
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "accordions", function() { return accordions; });
/* harmony import */ var _accordions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./accordions */ "./js/modules/accordeon/accordions.js");
