...
/* harmony import */ var _modules_accordeons_aboutus__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/accordeons/aboutus */ "./js/modules/accordeons/aboutus.js");
/* harmony import */ var _modules_accordeons_footer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/accordeons/footer */ "./js/modules/accordeons/footer.js");
/* harmony import */ var _modules_validation_phone_mask__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/validation/phone-mask */ "./js/modules/validation/phone-mask.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    Object(_modules_accordeons_aboutus__WEBPACK_IMPORTED_MODULE_3__["aboutUsButtonClick"])();
    Object(_modules_accordeons_footer__WEBPACK_IMPORTED_MODULE_4__["accordionRealisation"])();
    Object(_modules_validation_phone_mask__WEBPACK_IMPORTED_MODULE_5__["phoneMask"])();
  });
});
...
/***/ "./js/modules/accordeons/aboutus.js":
/*!******************************************!*\
  !*** ./js/modules/accordeons/aboutus.js ***!
  \******************************************/
/*! exports provided: aboutUsButtonClick */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aboutUsButtonClick", function() { return aboutUsButtonClick; });
var aboutUsButton = document.querySelector('.aboutus__button');
var aboutUsButtonMore = document.querySelector('.aboutus__button--more');
var aboutUsButtonCollapse = document.querySelector('.aboutus__button--collapse');
var mobileHiddenText = document.querySelector('[data-text-status="mobile-hidden"]');
var hiddenText = document.querySelector('[data-text-status="hidden"]');
...
var aboutUsButtonClick = function aboutUsButtonClick() {
...
/***/ "./js/modules/accordeons/footer.js":
/*!*****************************************!*\
  !*** ./js/modules/accordeons/footer.js ***!
  \*****************************************/
/*! exports provided: accordionRealisation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "accordionRealisation", function() { return accordionRealisation; });
...
var iconPlus = document.querySelector('.footer__accordeon-icon--plus');
var iconMinus = document.querySelector('.footer__accordeon-icon--minus');
var accordeons = document.querySelectorAll('.js-accordion');
function findElements(object, element) {
  var instance = object; // шаг 3 тут пустота пока
...
function showElement(object) {
  ...
  target.style.height = "".concat(height, "px"); // шаг 10 на answer навесили сохранненую высоту
...
function changeElementStatus(instance) {
  if (instance.isActive) {
    // ша 12 когда на элемент кликнули 2-й раз тут будет уже true
...
function measureHeight(object) {
  var instance = object; // шаг 6 тут теперь уже не пусто, тут те самые параметры что в findElements
...
function subscribe(instance) {
  instance.element.addEventListener('click', function (event) {
    // шаг 8 на каждый js-accordion вешаем слушатель клика
    event.preventDefault();
    changeElementStatus(instance);
  });
  window.addEventListener('resize', function () {
    return measureHeight(instance);
  }); // слушает изменение размера окна браузера (ну или вьюпорта) и меняет исходя из этого высоту каждого target (ну или answer)
}

function accordion(element) {
  // эта функция будет выполняться для каждого элемента
  var instance = {};
  function init() {
    closeAccordions();
...
var elements = _toConsumableArray(document.querySelectorAll('.js-accordion')); // шаг 1 – записываем все элементы аккордеона
var accordionRealisation = elements.forEach(accordion); // шаг 2 проходим по всем элементам функцией accordion
...
var Modals = /*#__PURE__*/function () {
  ...
  _createClass(Modals, [{
    ...
    value: function open() {
      ...
      var inputFocused = modal.querySelector('[data-input-status="focused"]');
...
/***/ "./js/modules/validation/phone-mask.js":
/*!*********************************************!*\
  !*** ./js/modules/validation/phone-mask.js ***!
  \*********************************************/
...
var phoneMask = window.addEventListener('DOMContentLoaded', function () {
