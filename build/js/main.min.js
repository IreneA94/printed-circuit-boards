...
var mobileHiddenText = document.querySelector('.aboutus__text--mobile-hidden');
var hiddenTexts = document.querySelectorAll('[data-text-status="hidden"]');
var textToggle = function textToggle() {
  if (aboutUsButton.classList.contains('is-closed')) {
    ...
    for (var _i = 0; _i < hiddenTexts.length; _i++) {
      hiddenTexts[_i].style.display = 'none';
    }
    if (window.innerWidth < 768) {
